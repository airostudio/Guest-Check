-- GuestCheck — Full Database Setup
-- Run this in Supabase SQL Editor to initialise the schema from scratch.
-- ─────────────────────────────────────────────────────────────────────────────
...
CREATE TABLE "GuestPhone" (
  ...
  CONSTRAINT "GuestPhone_guestId_fkey" FOREIGN KEY ("guestId") REFERENCES "Guest"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "ApiKey" (
  ...
  CONSTRAINT "ApiKey_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "Property"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Integration" (
  ...
  CONSTRAINT "Integration_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "Property"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- ── Prisma migrations table (lets prisma migrate deploy track state) ──────────
